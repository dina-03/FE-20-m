...
addCommentToMessage(0,new Comment(3, 'good', new Date().toLocaleDateString()));
addCommentToMessage(0,new Comment(1, 'bad', new Date().toLocaleDateString()));
addCommentToMessage(2,new Comment(2, 'das war schön!', new Date().toLocaleDateString()));
addCommentToMessage(10,new Comment(2, 'круто', new Date().toLocaleDateString()));
addCommentToMessage(12,new Comment(3, 'не могу не согласиться', new Date().toLocaleDateString()));
addCommentToMessage(3,new Comment(4, 'не могу не согласиться', new Date().toLocaleDateString()));
addCommentToMessage(5,new Comment(2, 'не могу не согласиться', new Date().toLocaleDateString()));
addCommentToMessage(9,new Comment(1, 'не могу не согласиться', new Date().toLocaleDateString()));
addCommentToMessage(9,new Comment(3, 'не могу не согласиться', new Date().toLocaleDateString()));
addCommentToMessage(8,new Comment(1, 'проще нужно относиться ко всему', new Date().toLocaleDateString()));
addCommentToMessage(15,new Comment(0, 'это просто чума!!!', new Date().toLocaleDateString()));
addCommentToMessage(4,new Comment(3, 'это просто чума!!!', new Date().toLocaleDateString()));
